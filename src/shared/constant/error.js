...
export const INVALID_PHONE_NUMBER_LENGTH =
...
export const REGULAR_EXPRESSION_PATTREN_ERROR =
  "2 validation errors detected: Value at 'previousPassword' failed to satisfy constraint: Member must satisfy regular expression pattern: ^[\\S]+.*[\\S]+$; Value at 'proposedPassword' failed to satisfy constraint: Member must satisfy regular expression pattern: ^[\\S]+.*[\\S]+$";
export const USER_INVITATION = 'User Invitation failed';
export const ATTEMP_LIMIT_EXCEDED =
  'Attempt limit exceeded, please try after some time.';
export const INVALID_EMAIL = 'Your email is invalid!';
export const NEW_AND_CONFIRM_PASSWORD = 'Please enter new and confirm password';
export const PASSWORD_MUST_BE_ALPHANUMERIC =
  'Password should be at least 8 characters long and contain alphanumeric characters';
